...
<html>
<head>
	<title>Wedrive | Book a cab now</title>
	<meta charset="utf-8">
	...
	<div class="book-container">
		<div class="Qub-booking">
			<div class="booking-tab">
				<span class="tab-button" id="tab-c"><a href="#" class="links tab tab-active" onclick="bookMood(1);">InCity-Taxi</a></span>
							...
							<div class="row row-cab">
								...
								<div class="right">
									...
									<div class="cab-detail">
										Get an Rickshaw at your doorstep
									</div>
								</div>
							</div>
						</div>
