...
<body>
	...
	<div class="top-banner">
		<div class="f-overlay">
			<div class="banner">
				<div id="top_heading">
					<h1 id="top_title">Book a Car and reach your destination</h1>
	...
	<div class="service-info">
		<div class="section-heading">
			<h2 class="section-title">A Car for every occassion</h2>
			<label class="section-subtitle">Wedrive offers city taxis, inter-city cabs, and local cabs at hourly packages</label>
		</div>
		<br>
		<div class="card-list-item">
			<div class="card-holder">
				<div class="indiv-card">
					<img class="card-image" src="img/islamabad.jpg">
					<div class="info-container">
						<h2 class="heading"><strong>city taxi</strong></h2>
						<p class="info">The perfect way to get through your everyday travel needs. City taxis are available 24/7 and you can book and travel in an instant. With rides starting from as low as Rs. 150/km, you can choose from a wide range of options! You can also opt to do your bit for the environment with Share!</p>
					</div>
				</div>
			</div>
			<div class="card-holder" id="card2">
				<div class="indiv-card">
					<img class="card-image" src="img/highway.jpg">
					<div class="info-container">
						<h2 class="heading"><strong>outstation</strong></h2>
						<p class="info">Ride out of town at affordable one-way and round-trip fares with intercity travel service. Choose from a range of AC cabs driven by top partners, available in 1 hour or book upto 7 days in advance. We have you covered across Pakistan with presence in 10+ cities with over 500 routes.</p>
					</div>
				</div>
			</div>
			<div class="card-holder">
				<div class="indiv-card">
					<img class="card-image" src="img/Karachi-1.jpg">
					<div class="info-container">
						<h2 class="heading"><strong>fleet</strong></h2><p class="info">With Fleet you get a cab at your doorstep. So be it a  day long business meeting, a shopping trip with your friends or just a day out in a new city, we have you covered. Packages start at 1 hour and can be extended upto 5 days.</p>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="slide fade">
					...
					<div class="right-content">
						<div class="wd-40">
							...
							<div class="info">Fully air conditioned cars that you can share with others.</div>
						</div>
					</div>
				</div>
				<div class="slide fade">
					...
					<div class="right-content">
						<div class="wd-40">
							<h4 class="heading">Rickshaw</h4>
							<div class="sub-title">Get an Auto-Rickshaw at your doorstep</div>
