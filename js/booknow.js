...
function initMap(position){
	...
	// API_KEY: AIzaSyAVr_QI5v7Lsrb7WTXEiTNWeubdYUHK7VE
    let url_str = 'https://maps.googleapis.com/maps/api/geocode/json?latlng='+lati+','+lngi+'&key=AIzaSyAVr_QI5v7Lsrb7WTXEiTNWeubdYUHK7VE'
    ...
    google.maps.event.addListener(marker, 'dragend', function(evt){
    	...
    	let url_str = 'https://maps.googleapis.com/maps/api/geocode/json?latlng='+evt.latLng.lat().toFixed(3)+','+evt.latLng.lng().toFixed(3)+'&key=AIzaSyAVr_QI5v7Lsrb7WTXEiTNWeubdYUHK7VE'
    	$.getJSON(url_str, function(data) {
        	console.log(data);
