    ...
    <div class="navbar">
		<div class="max-width">
			...
			<div class="navbar-brand">
				...
				<a href="index.php" class="links logo"><strong>Wedrive</strong></a>
			</div>
		...
		<?php
            ...
            <div class="navbar-left">
				<a href="user.php" class="links">Hello <?php echo $_SESSION['firstname']; ?></a>
			</div>

			<div class="navbar-right">
				<a href="fleet.php" class="links">Drive Fleet</a>
		...
		<div class="sidebar-navbar" style="">
			...
			<ul class="nav_ul">
				<li><a href="user.php" class="links nav-links">
				...
				<li><a href="fleet.php" class="links nav-links">
						<img src="img/svg/fleet.svg" class="material-icon"> Fleet</a></li>
        ...
        <?php } else {  ?>
			...
			<div class="navbar-right">
				<a href="fleet.php" class="links">Fleet</a>
				<a href="drive.php" class="links">Drive</a>
		...
		<div class="sidebar-navbar" style="">
			...
			<ul class="nav_ul">
				...
				<li><a href="drive.php" class="links nav-links">
						<img src="img/svg/direction.svg" class="material-icon">Drive</a></li>
				<li><a href="aboutus.php" class="links nav-links">
						<img src="img/svg/company.svg" class="material-icon">Our Company</a></li>
