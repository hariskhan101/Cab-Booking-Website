...
<head>
	<meta charset="utf-8">
	<title>Wedrive | Drive with Us</title>
...
<body>
	...
	<div class="main-slider">
		...
		<div class="display-container hide-slides">
			...
			<div class="img-heading">
				...
				<label class="img-subtitle">
					With 100 quality checks, our cars are always as good as new
				</label>
			</div>
		</div>
		<div class="display-container hide-slides">
	...
	<div class="service-info">
		<div class="section-heading">
			<h2 class="section-title">Why Drive with Wedrive?</h2>
		</div>
		<div class="item-list">
			<div class="wd-50">
			...
			<div class="wd-50">
				...
				<div class="indiv-item" style="margin-left: 0">
					...
					<div class="wd-70">
						...
						<p class="info">Complete peace of mind with damage liability limited to Rs 20,000.</p>
					</div>
				</div>
				<div class="indiv-item" style="margin-left: 0">
					<div class="wd-30">
